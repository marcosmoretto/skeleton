...
return [
    ...
    'service_manager' => [
        'factories' => [
            ...
            \User\V1\Rest\Device\DeviceResource::class => \User\V1\Rest\Device\DeviceResourceFactory::class,
            \User\V1\Rest\DeviceManager\DeviceManagerResource::class => \User\V1\Rest\DeviceManager\DeviceManagerResourceFactory::class,
        ],
        'abstract_factories' => [
        ...
        'routes' => [
            ...
            'user.rest.device' => [
                ...
                'options' => [
                    ...
                    'defaults' => [
                        'controller' => 'User\\V1\\Rest\\Device\\Controller',
                    ],
                ],
            ],
            'user.rest.device-manager' => [
                'type' => 'Segment',
                'options' => [
                    'route' => '/device-manager[/:device_manager_id]',
                    'defaults' => [
                        'controller' => 'User\\V1\\Rest\\DeviceManager\\Controller',
                    ],
                ],
            ],
        ],
    ...
    'zf-content-negotiation' => [
        'controllers' => [
            ...
            'User\\V1\\Rest\\Device\\Controller' => 'Json',
            'User\\V1\\Rest\\DeviceManager\\Controller' => 'Json',
        ],
        'accept_whitelist' => [
            'User\\V1\\Rpc\\Signup\\Controller' => [
                0 => 'application/json',
            ...
            'User\\V1\\Rest\\Device\\Controller' => [
                0 => 'application/vnd.user.v1+json',
                1 => 'application/hal+json',
                2 => 'application/json',
            ],
            'User\\V1\\Rest\\DeviceManager\\Controller' => [
                0 => 'application/vnd.user.v1+json',
                1 => 'application/hal+json',
                2 => 'application/json',
            ],
    ...
    'zf-content-validation' => [
        ...
        'User\\V1\\Rest\\Device\\Controller' => [
            'input_filter' => 'User\\V1\\Rest\\Device\\Validator',
        ],
        'User\\V1\\Rest\\DeviceManager\\Controller' => [
            'input_filter' => 'User\\V1\\Rest\\DeviceManager\\Validator',
        ],
    ],
    'input_filter_specs' => [
        ...
        'User\\V1\\Rest\\DeviceManager\\Validator' => [
            0 => [
                'required' => true,
                'validators' => [],
                'filters' => [
                ...
                'name' => 'player_id',
                'description' => 'player_id do gestor',
                'field_type' => 'String',
            ],
        ],
    ],
    'zf-rest' => [
        ...
        'User\\V1\\Rest\\Device\\Controller' => [
            'listener' => \User\V1\Rest\Device\DeviceResource::class,
            'route_name' => 'user.rest.device',
            ...
            'page_size' => 25,
            'page_size_param' => null,
            'entity_class' => \User\V1\Rest\Device\DeviceEntity::class,
            'collection_class' => \User\V1\Rest\Device\DeviceCollection::class,
            'service_name' => 'Device',
        ],
        'User\\V1\\Rest\\DeviceManager\\Controller' => [
            'listener' => \User\V1\Rest\DeviceManager\DeviceManagerResource::class,
            'route_name' => 'user.rest.device-manager',
            'route_identifier_name' => 'device_manager_id',
            'collection_name' => 'device_manager',
            'entity_http_methods' => [
                0 => 'GET',
                1 => 'PATCH',
                2 => 'PUT',
            ...
            'page_size' => 25,
            'page_size_param' => null,
            'entity_class' => \User\V1\Rest\DeviceManager\DeviceManagerEntity::class,
            'collection_class' => \User\V1\Rest\DeviceManager\DeviceManagerCollection::class,
    ...
    'zf-hal' => [
        'metadata_map' => [
            ...
            \User\V1\Rest\Device\DeviceEntity::class => [
                'entity_identifier_name' => 'id',
                'route_name' => 'user.rest.device',
                'route_identifier_name' => 'device_id',
                'hydrator' => \Zend\Hydrator\ArraySerializable::class,
            ],
            \User\V1\Rest\Device\DeviceCollection::class => [
                'entity_identifier_name' => 'id',
                'route_name' => 'user.rest.device',
                'route_identifier_name' => 'device_id',
                'is_collection' => true,
            ],
            \User\V1\Rest\DeviceManager\DeviceManagerEntity::class => [
                'entity_identifier_name' => 'id',
                'route_name' => 'user.rest.device-manager',
                'route_identifier_name' => 'device_manager_id',
                'hydrator' => \Zend\Hydrator\ArraySerializable::class,
            ],
            \User\V1\Rest\DeviceManager\DeviceManagerCollection::class => [
                'entity_identifier_name' => 'id',
                'route_name' => 'user.rest.device-manager',
                'route_identifier_name' => 'device_manager_id',
                'is_collection' => true,
